...
**Rails-React** is a simple project that is aimed to practice configuring rails with reactjs.
...
- **Ability to use react as a frontend framework and Rails as a backend all in one**
...
```sh
  ...
  git clone https://github.com/degisew/hello-rails-react.git
```
...
4. Navigate to the folder called hello-rails-react/ and open this project using your editor
### Usage
...
Feel free to check the [issues page](https://github.com/degisew/hello-rails-react/issues/).
...
This project is [MIT](https://github.com/degisew/hello-rails-react/blob/dev/LICENSE) licensed.
